...
var defaults = {
    ...
    height: '500px', // String; Height of jGallery container(only for standard or slider mode).
    ...
    maxMobileWidth: 400, // Number; Maximum width(px) for jGallery shows a view for mobile device.
    ...
    thumbnails: false, // Boolean; If set as 'true', thumbnails will be displayed.; [ true, false ]
